...
class Apertus1p5Processor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, feature_extractor=None, tokenizer=None, chat_template=None, **kwargs):
        ...
        self.audio_start_token = getattr(tokenizer, "audio_start_token", None) or "<|audio_start|>"
        self.audio_end_token = getattr(tokenizer, "audio_end_token", None) or "<|audio_end|>"
    ...
    def replace_audio_token(self, audio_inputs: dict, audio_idx: int) -> str:
        ...
        return f"{self.audio_start_token}{self.audio_token * num_codes}{self.audio_end_token}"
