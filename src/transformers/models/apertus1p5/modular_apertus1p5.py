...
class Apertus1p5Config(PreTrainedConfig):
    ...
    boi_token_id (`int`, *optional*, defaults to 131073):
        Id of the `<|img_start|>` token opening an image block.
    eoi_token_id (`int`, *optional*, defaults to 131074):
        Id of the `<|img_end|>` token closing an image block.
    image_wrapper_token_id (`int`, *optional*, defaults to 131075):
        Id of the `<|img_token_start|>` token separating the size header from the image codes.
    eol_token_id (`int`, *optional*, defaults to 131076):
        Id of the `<|img_end_of_row|>` token joining image code rows.
    audio_start_token_id (`int`, *optional*, defaults to 131080):
        Id of the `<|audio_start|>` token opening an audio block.
    audio_end_token_id (`int`, *optional*, defaults to 131081):
        Id of the `<|audio_end|>` token closing an audio block.
    ...
    boi_token_id: int = 131073
    eoi_token_id: int = 131074
    image_wrapper_token_id: int = 131075
    eol_token_id: int = 131076
    audio_start_token_id: int = 131080
    audio_end_token_id: int = 131081
